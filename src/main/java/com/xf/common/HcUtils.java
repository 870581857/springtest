...
public class HcUtils {
    ...
    String loginUrl = "http://localhost:8088/api/notFilter/loginAuth";
    ...
    public void testLogin() throws Exception {
        ...
        parameterMap.put("phone", "18301155212");
        parameterMap.put("password", "xiefei321");
        parameterMap.put("authCode", "");
        parameterMap.put("loginType", "1");
        parameterMap.put("countryCode", "+86");
        parameterMap.put("autoLogin", "1");
